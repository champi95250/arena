...
--		end)
		...
		if has_repicked and has_randomed then
			PlayerResource:SetGold(player_id, STARTING_GOLD +100, false)
		elseif has_repicked then
			PlayerResource:SetGold(player_id, STARTING_GOLD -100, false)
		elseif has_randomed or IMBA_PICK_MODE_ALL_RANDOM or IMBA_PICK_MODE_ALL_RANDOM_SAME_HERO then
			PlayerResource:SetGold(player_id, STARTING_GOLD +200, false)
		else
			PlayerResource:SetGold(player_id, STARTING_GOLD, false)
		end
