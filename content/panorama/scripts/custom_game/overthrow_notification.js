...
//==============================================================
//==============================================================
function Onbattlebegin( msg , data )
{
//	$.Msg( "leader_has_been_killed: ", msg );

	$.GetContextPanel().SetHasClass( "On_battlebegin", true );
	// var Scoreafaire = teamPanel.GetAttributeInt( "recent_score_count", 0 );
	$( "#Battle_Begin_b" ).SetDialogVariable( "Teampointtowin", $.Localize( "#"+msg.Teampointtowin ) );

	$.Schedule( 5, ClearKillMessagebattle );
}
		
function ClearKillMessagebattle()
{
	$.GetContextPanel().SetHasClass( "On_battlebegin", false );
}


//==============================================================
//==============================================================
function Onbattlechiken( data )
{
//	$.Msg( "Overtime Goal: ", data );
...
{
	$.GetContextPanel().SetHasClass( "On_battlechiken", false );
}
...
(function () {
    ...
    GameEvents.Subscribe( "battle_begiin", Onbattlebegin );
    GameEvents.Subscribe( "battle_chiken", Onbattlechiken );
})();
